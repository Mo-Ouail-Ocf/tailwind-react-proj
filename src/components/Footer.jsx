    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid
      lg:grid-cols-3 gap-8 text-gray-300">
        <div>
          ...
          <p className='py-4'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id placeat dolore sapiente corrupti deserunt possimus at quis nisi molestiae, dicta recusandae vel explicabo fugiat maiores cumque, fuga harum cum ratione.
          </p>
